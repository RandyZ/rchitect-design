import { ComponentType, WmqFormSchema } from '#/form'
...
export function transferFormilySchemas(props?: any): WmqFormSchema[] {
  let schemas: WmqFormSchema[] = []
...
const propsToSchema = (field: string, props: any): WmqFormSchema => {
  return {
    field,
    label: props['title'],
