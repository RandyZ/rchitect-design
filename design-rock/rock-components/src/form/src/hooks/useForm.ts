...
import { WmqFormProps, WmqFormSchema } from '../type'
import { error } from '#/index'

export interface formMethod {
  // reload: () => void
  setProps: (props: WmqFormProps) => void
  validate: (
  ...
  updateSchemas: (schemas: WmqFormSchema) => void
}

export function useForm(props: WmqFormProps) {
