import {
  ...
  ColorPreset,
  MenuModeEnum,
  MenuTypeEnum, MixSidebarTriggerEnum, PermissionModeEnum, RouterTransitionEnum,
  SessionTimeoutProcessingEnum, SettingButtonPositionEnum, ThemeEnum, TriggerEnum
} from "@rchitect-design/constants";
import { ProjectConfig } from "@rchitect-design/types";
/**
 * TODO 这个默认配置需要分开到不同的设置中
 * 
 * @description: 项目配置文件
 */
export default {
