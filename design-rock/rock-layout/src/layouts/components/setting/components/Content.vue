...
<template>
  <WmqSpace vertical>
    ...
    <SwitchItem :title="t('layout.setting.tabsRedoBtn')" :def="getShowRedo" :event="HandlerSettingEnum.TABS_SHOW_REDO"
      :disabled="!getShowMultipleTab" />
    <SwitchItem :title="t('layout.setting.tabsQuickBtn')" :def="getShowQuick" :event="HandlerSettingEnum.TABS_SHOW_QUICK"
      :disabled="!getShowMultipleTab" />
    <SwitchItem :title="t('layout.setting.tabsFoldBtn')" :def="getShowFold" :event="HandlerSettingEnum.TABS_SHOW_FOLD"
      :disabled="!getShowMultipleTab" />
    <SwitchItem :title="t('layout.setting.sidebar')" :def="getShowMenu" :event="HandlerSettingEnum.MENU_SHOW_SIDEBAR"
      :disabled="getIsHorizontal" />
    <SwitchItem :title="t('layout.setting.header')" :def="getShowHeader" :event="HandlerSettingEnum.HEADER_SHOW" />
    <SwitchItem title="Logo" :def="getShowLogo" :event="HandlerSettingEnum.SHOW_LOGO" :disabled="isMenuMixSidebarType" />
    <SwitchItem :title="t('layout.setting.footer')" :def="getShowFooter" :event="HandlerSettingEnum.SHOW_FOOTER" />
    <SwitchItem :title="t('layout.setting.fullContent')" :def="getFullContent" :event="HandlerSettingEnum.FULL_CONTENT" />
