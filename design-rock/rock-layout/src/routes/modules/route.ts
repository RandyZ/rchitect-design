import type { RouteMeta, Router, RouteRecordNormalized } from '@rchitect-rock/router'
import { Exception } from '#/pages'
import { omit, cloneDeep } from 'lodash-es'
import { createRouter, createWebHashHistory } from '@rchitect-rock/router'
import { Layout as LAYOUT } from '#/layouts'
import { AsyncComponentLoader, Component } from 'vue-demi'
...
LayoutMap.set('LAYOUT', () => Promise.resolve(LAYOUT))
LayoutMap.set('IFRAME', () => import('#/pages').then((m) => m.FrameBlank as Component))
LayoutMap.set('EXCEPTION', () => Promise.resolve(Exception))
