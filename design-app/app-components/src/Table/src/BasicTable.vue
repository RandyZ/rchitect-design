...
<script lang="ts">
  ...
  // TODO: 路径
  import Table from '#/table-page/src/Table.vue';
  // TODO: 路径
    ...
    setup(props, { attrs, emit, slots, expose }) {
      ...
      watchEffect(() => {
        unref(isFixedHeightPage) &&
          props.canResize &&
          (diK(THROWN_HANDLER)?.warn("'canResize' of BasicTable may not work in PageWrapper with 'fixedHeight' (especially in hot updates)"));
      });
