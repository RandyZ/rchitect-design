<script lang="tsx">
  ...
  export default defineComponent({
    name: 'EditableCell',
    components: { WmqIconify, CellComponent },
    directives: {
      clickOutside,
    },
    props: {
      ...
      return (
        <div class={this.prefixCls}>
          ...
          >
            ...
            {!this.column.editRow && <WmqIconify icon="ant-design:form-outlined" class={`${this.prefixCls}__normal-icon`} />}
              ...
              <div class={`${this.prefixCls}__wrapper`} v-click-outside={this.onClickOutside}>
                ...
                {!this.getRowEditable && (
                  <div class={`${this.prefixCls}__action`}>
                    <WmqIconify icon="ant-design:check-outlined"
                                class={[`${this.prefixCls}__icon`, 'mx-2']}
                                onClick={this.handleSubmitClick}/>
                    <WmqIconify icon="ant-design:close-outlined" class={`${this.prefixCls}__icon `} onClick={this.handleCancel} />
