  ...
  export default defineComponent({
    ...
    setup(props, { attrs, slots, emit, expose }) {
      ...
      function handleSearch(searchValue: string) {
        ...
        const { label: labelField, id: idField } = unref(getFieldNames);
        ...
        searchState.searchData = filter(
          ...
          (node) => {
            const result = filterFn
              ...
              : node[labelField]?.includes(searchValue) ?? false;
            if (result) {
              matchedKeys.push(node[idField]);
            }
            return result;
          },
          unref(getFieldNames),
      ...
      const treeData = computed(() => {
        ...
        eachTree(data, (item, _parent) => {
          ...
          const title = get(item, labelField);
          ...
          <div class={[bem(), 'h-full', attrs.class]}>
            ...
            >
              <ScrollContainer style={scrollStyle} v-show={!unref(getNotFound)}>
                <WmqTree {...unref(getBindValues)} showIcon={false} data={treeData.value} />
              </ScrollContainer>
              <ElEmpty
