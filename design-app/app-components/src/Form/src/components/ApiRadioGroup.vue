...
<template>
  <template>
    <WmqRadioButtonGroup v-if="props.isBtn" v-bind="attrs" v-model:value="state" button-style="solid" :options="getOptions" @change="handleClick"></WmqRadioButtonGroup>
    <WmqRadioGroup v-else v-bind="attrs" v-model:value="state" :options="getOptions" @change="handleClick"></WmqRadioGroup>
  </template>
</template>
<script lang="ts">
